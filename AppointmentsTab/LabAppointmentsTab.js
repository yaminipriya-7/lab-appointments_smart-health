...
// ]
const LabAppointmentsTab = ({navigation}) => {
        ...
        await fetch(BASE_URL+'/doctorAppointment/web/all/'+apiEndPoints[index]+'?draw=5&start=0&length=100&search[value]=', requestOptions) 
            .then(response => { 
                ...
                .then(responceData => { 
                    ...
                    setDoctorsData(responceData.data);
                                                ...
                                                <View style={[GlobalStyleSheet.row]}>
                                                    ...
                                                    <View style={[GlobalStyleSheet.col66]}>
                                                        ...
                                                        <View style={{flexDirection:"row"}}>
                                                            ...
                                                            <Text style={{...styles.consultationfee}}>09.00 AM - 07.00 PM Today</Text>
                                                        </View>  
                                                        ...
                                                        {( clickedButton === "Upcoming") &&
                                                            <View style={[{width:'100%'}]}>
                                                                <ButtonOutline btnRounded fontTextSize={12} color={'#fff'} title={'Start Meeting'} style={{borderWidth:2,backgroundColor:'#1F2587',width:'auto',paddingVertical:5,marginVertical:10}}/>
                                                            </View>
                                                        } 
                                                    </View>
                                                </View>
